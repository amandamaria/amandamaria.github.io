...
exports.useReferenceArrayInputController = function (props) {
    ...
    var _m = dataProvider_1.useGetMany(reference, idsToFetch || []), referenceRecordsFetched = _m.data, loaded = _m.loaded, refetchGetMany = _m.refetch;
    ...
    var _o = useGetMatching_1.default(reference, pagination, sort, finalFilter, source, resource, options), matchingReferences = _o.data, matchingReferencesIds = _o.ids, total = _o.total, refetchGetMatching = _o.refetch;
