...
var useRedirect = function () {
    ...
    return react_1.useCallback(function (redirectTo, basePath, id, data, state) {
        ...
        history.push(__assign(__assign({}, history_1.parsePath(resolveRedirectTo_1.default(redirectTo, basePath, id, data))), { state: __assign({ _scrollToTop: true }, state) }));
    }, [dispatch, history]);
};
