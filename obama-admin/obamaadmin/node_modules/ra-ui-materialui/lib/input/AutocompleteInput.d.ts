...
export interface AutocompleteInputProps extends ChoicesInputProps<TextFieldProps>, Omit<SupportCreateSuggestionOptions, 'handleChange'>, Omit<DownshiftProps<any>, 'onChange'> {
