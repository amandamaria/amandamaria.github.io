...
declare const SimpleList: {
    ...
    propTypes: {
        ...
        primaryText: PropTypes.Requireable<(...args: any[]) => any>;
        rightAvatar: PropTypes.Requireable<(...args: any[]) => any>;
        rightIcon: PropTypes.Requireable<(...args: any[]) => any>;
        secondaryText: PropTypes.Requireable<(...args: any[]) => any>;
        tertiaryText: PropTypes.Requireable<(...args: any[]) => any>;
        rowStyle: PropTypes.Requireable<(...args: any[]) => any>;
    };
};
export declare type FunctionToElement<RecordType extends Record = Record> = (record: RecordType, id: Identifier) => ReactElement | string;
