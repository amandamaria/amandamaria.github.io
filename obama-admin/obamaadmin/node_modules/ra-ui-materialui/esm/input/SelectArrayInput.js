...
var SelectArrayInput = function (props) {
    ...
    var renderMenuItem = useCallback(function (choice) {
        return choice ? (React.createElement(MenuItem, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id
            ? createItem.name
